                ...
                if ":" in line:
                    ...
                    if "rating" in line:
                        ...
                        if "comedy" in line.lower():
                            type_list.append(MovieType.COMEDY)
                        if "drama" in line.lower():
                            type_list.append(MovieType.DRAMA)
                        if "criminal" in line.lower():
                            type_list.append(MovieType.CRIMINAL)
                        if "romantic" in line.lower():
                            type_list.append(MovieType.ROMANTIC)
                        if "biography" in line.lower():
                            type_list.append(MovieType.BIOGRAPHY)
                        if "adventure" in line.lower():
                            type_list.append(MovieType.ADVENTURE)
                else:      
                    self.films.append(Movie(title, rating, type_list, production, premiere))
